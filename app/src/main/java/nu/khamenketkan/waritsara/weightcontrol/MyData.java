...
public class MyData {
    ...
    //Explicit
    String[] foodStrings = new String[]{"ข้าวผัดกะเพราหมู",
    ...
    String[] unitStrings = new String[]{"จาน",
            "จาน","จาน",
            "จาน","จาน",
            "ชาม", "จาน",
            "ถ้วย","จาน","ชาม", };
    String[] caloriesStrings = new String[]{"580",
            "554", "540",
            "622", "630",
            "240", "435",
            "320", "577", "180",};
    String[] exerciseStrings = new String[]{"exercise0","exercise1","exercise2","exercise3","exercise4",
            "exercise5","exercise6","exercise7","exercise8","exercise9",};
    String[] burnStrings = new String[]{"100",
            "200",
            "300",
            "400",
            "500",
